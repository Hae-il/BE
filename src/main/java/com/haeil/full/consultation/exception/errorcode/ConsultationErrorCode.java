package com.haeil.full.consultation.exception.errorcode;
...
public enum ConsultationErrorCode implements ErrorCode {
    ...
    INVALID_CONSULTATION_RESERVATION_STATUS_TRANSITION(
            HttpStatus.BAD_REQUEST, "예약 상태는 PENDING 상태에서만 변경할 수 있습니다.");
