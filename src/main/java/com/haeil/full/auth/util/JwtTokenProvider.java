package com.haeil.full.auth.util;

import com.haeil.full.user.service.CustomUserDetailService;
...
public class JwtTokenProvider {
    ...
    // Request의 Header 또는 Cookie에서 token 값을 가져오기
            ...
            for (Cookie cookie : cookies) {
                if ("Authorization".equals(cookie.getName())) {
                    ...
                    if (cookieValue != null && !cookieValue.isEmpty()) {
                        return cookieValue; // 쿠키에는 토큰만 저장되어 있음
                    }
                }
            }
        }
