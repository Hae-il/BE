...
public class CasesService {
    ...
    public List<RequestedCaseResponse> getRequestedCases(Long userId) {
        ...
        return casesRepository.findByCaseStatusAndAttorney(CaseStatus.PENDING, attorney)
                .stream()
    ...
    public List<OngoingCaseResponse> getOngoingCases(Long userId) {
        ...
        return casesRepository.findByCaseStatusAndAttorney(CaseStatus.IN_PROGRESS, attorney)
                .stream()
