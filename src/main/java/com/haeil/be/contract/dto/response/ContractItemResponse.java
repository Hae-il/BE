...
public record ContractItemResponse(Long contractId, String caseNumber, ContractStatus status, LocalDate dueDate) {
    // String attorneyName랑 String clientName가 포함되어야 하는데, 지금 Case랑 Consultation이 매핑이 안되어 있어서 일단 제외했습니다.
